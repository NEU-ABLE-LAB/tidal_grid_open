...
if strcmp(nameValueArgs.flow_cost_E, 'default') 
    % nameValueArgs.flow_cost_P is the scalar multiple on the cost
    ...
    nameValueArgs.flow_cost_E = nameValueArgs.flow_cost_P...
    ...
    nameValueArgs.flow_cost_P = @(x)(...
        nameValueArgs.flow_cost_P * (feval(flow_cost_E_fun, ...
